      ...
      <header class="header">
        ...
        <div id="app">
          <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            ...
            <div class="forms">
              <div class="form_title">ユーザー登録</div>
                <div class="form_content">
                  <form method="POST" action="{{ route('register') }}">
                    @csrf
                      <div class="row mb-3">
                        <label for="name" class="col-md-4 col-form-label text-md-end">おなまえ</label>
                          <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                          ...
                          <div class="row mb-3">
                            ...
                            <div class="row mb-3">
                              <label for="password-confirm" class="col-md-4 col-form-label text-md-end">パスワード再入力</label>
                                <div class="col-md-6">
